...
func TestImportExportQueues(t *testing.T) {
	...
	ctx2 = ctx2.WithBlockHeight(ctx2.BlockHeader().Height + int64(app2.GovKeeper.GetDepositParams(ctx2).MaxDepositPeriod+app2.GovKeeper.GetVotingParams(ctx2).VotingPeriod))
